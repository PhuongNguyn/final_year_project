...
import { clearSelectedWarehouse, getPagingWarehouse, getWarehouse, selectWarehouse } from "../store";
...
const WarehouseTable = ({ tableColumn }) => {
  ...
  const { params, warehouses, loading, totalDoc } = useSelector(
  ...
  const handleSelectRow = (value) => {
    console.log(value)
    dispatch(selectWarehouse(value))
    onOpenAdd();
  }
            ...
            >
                                ...
                                >
                                  <Button
                                    ...
                                    onClick={() => {
                                      ...
                                      handleSelectRow(cell.row.original)
                                    }
                                    }
                                  >
                                    <Flex
              ...
              >
                <Text
                  ...
                  mb={{ sm: "24px", md: "0px" }}
                >
                  Showing {pageSize * pageIndex + warehouses.length} of {totalDoc}{" "}
                  entries
                </Text>
                <Stack
                  direction="row"
